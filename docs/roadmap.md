...
- [x] **TASK-003** Serveur : DO « room » + lobby complet + broadcasts d'état — **12/12 tests intégration** (vérifié 2026-07-02)
- [x] **TASK-004** Client : routing, store WS synchronisé, Accueil + Salle d'attente, design system de base — **21 tests + E2E** (vérifié 2026-07-02)
- [x] **Déploiement en ligne** (2026-07-02) : Worker + Pages sur Cloudflare, chaîne WS validée en prod (`docs/deployment.md`)

**→ Lobby EN LIGNE et jouable : https://qui-paire-gagne.pages.dev — Phase 2 terminée. ✅**
