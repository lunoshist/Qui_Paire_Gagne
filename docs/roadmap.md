...
- [ ] **TASK-00X** Déploiement (Cloudflare Pages + Workers) — *nécessite `wrangler login` du commanditaire*

**→ Lobby jouable de bout en bout en local. Fin de Phase 2 (hors déploiement).**
